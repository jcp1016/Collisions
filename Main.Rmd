...
setwd("~/Columbia/DATA")
rawdata <- read.csv("NYPD_Motor_Vehicle_Collisions-2014.csv", header=TRUE)
setwd("~/Columbia/Collisions")
names(rawdata)[4] <- "ZIP"
...
```{r, echo=TRUE}
setwd("~/Columbia/Collisions/zip_codes_shp")
